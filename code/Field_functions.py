...
#     lam_x,lam_y = lam.flatten()
#     r2 = x**2+y**2
#     sol= (x*lam_y - y*lam_x)*np.array([[lam_y],[-lam_x]])/r2 - (x*lam_y - y*lam_x)**2 *q /r2**2
#     return sol
...
#     x,y = q.flatten()
#     uval = u
#     sol = np.array([uval@(np.array([0,1]) @lam) ,-uval@(np.array([1,0] )@lam) ])
#     sol -= u[0,0]**2 *q
#     return  sol
